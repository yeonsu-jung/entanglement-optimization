...
python run_nudge.py {NUM_RODS} {ASPECT_RATIO} {RANDOM_SEED} {TOTAL_STEPS}
...
for _ in range(1):    
    ...
    for _ in [0]:
        ...
        run_id = f"{timestamp}_RUN_nudge_every_AR{ASPECT_RATIO}_N{NUM_RODS}_{RANDOM_SEED}_{TOTAL_STEPS}"
        ...
        os.system(f"cp core/potentials.py runs/{run_id}")
        os.system(f"cp analysis/entangle_and_nudge_03.py runs/{run_id}/run_nudge.py")
