...
matobj = loadmat('/Users/yeonsu/GitHub/entanglement/trimmed_alpha38_epsilon00.mat',simplify_cells=True)
# %%
trimmed = matobj['trimmed']


length_list = np.array([ Segments.Segment.seg_len(trimmed[i]) for i in range(len(trimmed)) ])
# %%
fig,ax=plt.subplots()
ax.hist(length_list[length_list<1000],bins=100)