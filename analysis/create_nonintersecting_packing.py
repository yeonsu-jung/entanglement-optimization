...
# Add 'core' to sys.path relative to this script to allow imports from core modules
...
for AR in ARs:
    ...
    x = q_to_x(q)
    np.savetxt(f'/Users/yeonsu/GitHub/entanglement-optimization-combined/entanglement-optimization/nonintersecting_packings_contained/x_nonintersecting_packing_{AR}.txt', x)
