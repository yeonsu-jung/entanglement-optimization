...
# Perform SVD for the sparse matrix

# Create a sparse matrix using sparse_i, sparse_j, and sparse_dist
sparse_matrix = coo_matrix((sparse_dist, (sparse_i, sparse_j)), shape=(num_rods, num_rods))

# Perform SVD
k = 100  # Number of singular values/vectors to compute
