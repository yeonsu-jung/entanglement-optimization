...
# Entangle
protocol_id = 'EntangledCarrotCake5_all'
...
if os.path.exists(f'{output_path}/total_contact_over_time_data.pkl'):
    print(f'Loading data from {output_path}/total_contact_over_time_data.pkl')    
...
indices = [0, 1, 2, 3, 4, 6, 5]
for idx in indices:
    dta = total_contact_over_time_data[idx]
