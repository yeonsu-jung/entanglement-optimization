...
from potentials import dist_lin_seg_pbc
...
def create_nonintersecting_random_rods_contained(num_rods,rod_diameter,container_size,max_attempts=10000):
    ...
    # two cases
    # 1. both endpoints are inside the container
    # 2. centroid is inside the container
...
def create_nonintersecting_random_rods_contained_centroids(num_rods,rod_diameter,container_size,max_attempts=10000):
    ...
    for i in range(num_rods):
        ...
        while not created and attempts < max_attempts:
            ...
            x = onp.random.uniform(-container_size,container_size)
...
def create_nonintersecting_random_rods_contained_pbc(num_rods,rod_diameter,container_size,max_attempts=10000):
    # print('create_nonintersecting_random_rods in a container')
    ...
    for i in range(num_rods):
        ...
        while not created and attempts < max_attempts:
            ...
            for j in range(i):
                ...
                # dist_lin_seg_pbc(point1s, point1e, point2s, point2e, box)
